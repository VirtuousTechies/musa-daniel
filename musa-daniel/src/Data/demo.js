import { adBlockerCover, airMaxCover, define, design, foodAppCover, foodUserOne, foodUserTwo, hfOne, hfTwo, ideate, laughing, otherEight, otherFive, otherFour, otherNine, otherOne, otherSeven, otherSix, otherThree, otherTwo, pi, relieved, rideEaseCover, rideMainOne, rideMainTwo, screenOne, smiling, test, thinking, understand, ura, ut } from "."
...
export const rideEaseData = {
    ...
    userJourney: {
        actions: ['Discovery', 'Booking a ride', 'Waiting for the ride', 'Riding', 'Payment'],
        taskList: [["Friend's recommendation or online ad", 'Download the app and create an account, entering the payment and personal information'], ['Opens the app and enter destination.', 'Review fare estimate and confirm ride.', 'Option to choose the type of ride, such as a standard or premium vehicle, and select an eco-friendly option.'], ["Receive notification with the driver's name, vehicle information, and estimated time of arrival", "Track the driver's progress on the map and communicate with them through the app"], ["Get into the car and be greeted by the driver.", "Confirm the driver's identity and vehicle information to ensure her safety."], ["Ride will  automatically  be charged to account after the trip is complete.", "Option to rate the driver and provide feedback on the experience."]],
        feeling: [thinking, smiling, laughing, relieved, relieved],
        thoughts: ['Sarah may be thinking about how convenient it would be to use a ride-sharing app to get to her destination, and may be wondering if the app is easy to use and trustworthy.', "Sarah may be thinking about how long it will take for the driver to arrive, and may be checking the app frequently to track the driver's progress.", "Sarah may be thinking about how long it will take for the driver to arrive, and may be checking the app frequently to track the driver's progress.", "Sarah may be thinking about the route and the estimated arrival time, as well as the driver's behavior and the condition of the car.", 'Sarah may be thinking about the total fare and whether it matches her expectations, as well as the ease and security of the payment process.']
    }
}
